...
class HrEmployee(models.Model):
    ...
    #Añadir en compras y ventas respectivamente un campo donde pueda seleccionar el tipo de producto.
    ...
    descuentos_y_beneficios_e = fields.Selection(string='Descuentos y Beneficios', selection=[('1', 'Usuario'), ('2', 'Administrador')])
    ...
    descuentos_y_beneficios_i = fields.Selection(string='Descuentos y Beneficios', selection=[('1', 'Usuario'), ('2', 'Administrador'),])
