...
class ConsignmentNote(models.TransientModel):
    ...
    def create_report(self):
      ...
      for i in self.invoice_ids:
        ...
        xb = open("/odoo/custom/addons/Report_data/"+ new_string + '.xlsx', 'rb').read()
