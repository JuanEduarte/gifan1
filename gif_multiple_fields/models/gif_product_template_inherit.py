...
class ProductTemplate(models.Model):
    ...
    gif_type_ieps = fields.Selection(string='Tipo de IEPS', selection=[('1', 'Porcentual'), ('2', 'Fijo'),])
    gif_ieps_sale_por = fields.Float(string='Valor Porcentual IEPS')
    gif_ieps_sale_fij = fields.Float(string='Valor Fijo IEPS')
    gif_ieps_purchase_por = fields.Float(string='Valor Porcentual IEPS')
    gif_ieps_purchase_fij = fields.Float(string='Valor Fijo IEPS')
