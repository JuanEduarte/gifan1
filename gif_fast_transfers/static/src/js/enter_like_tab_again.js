odoo.define('gif_fast_transfers.enter_like_tab_again.js', function (require) {
        ...
        _onKeydown: function (ev) {
            switch (ev.which) {
                ...
                case $.ui.keyCode.ENTER:
                    console.log('Aquí es la funcion')
                    ...
                    if ((this.model === "gif.inventory") || (this.model === "gif.fast.capture")){
                        console.log('Aquí el modelo')
                        var event = this.trigger_up('navigation_move', {
                            direction: ev.shiftKey ? 'previous' : 'next',
                        });
                        if (event.is_stopped()) {
